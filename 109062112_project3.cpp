...
//std::cout << "player: " << new_othelloboard.player << std::endl;
    ...
    int count_player_discs(Point center) {
        ...
        if (temp.board[1][1] == player && temp.board[0][0] != player) count -= 5;
        if (temp.board[1][6] == player && temp.board[0][7] != player) count -= 5;
        if (temp.board[6][1] == player && temp.board[7][0] != player) count -= 5;
        if (temp.board[6][6] == player && temp.board[7][7] != player) count -= 5;
