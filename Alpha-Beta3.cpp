...
//std::cout << "player: " << new_othelloboard.player << std::endl;
    ...
    int count_player_discs(Point center) {
        ...
        if (temp.board[1][1] == player) count -= 5;
        if (temp.board[1][6] == player) count -= 5;
        if (temp.board[6][1] == player) count -= 5;
        if (temp.board[6][6] == player) count -= 5;
        if (temp.board[1][1] == (3^player)) count += 5;
        if (temp.board[1][6] == (3^player)) count += 5;
        if (temp.board[6][1] == (3^player)) count += 5;
        if (temp.board[6][6] == (3^player)) count += 5;
